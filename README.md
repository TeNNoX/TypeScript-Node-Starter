...
The main purpose of this repository is to show a working Node.js Service workflow for writing Node code in TypeScript.
...
```
git clone --depth=1 https://github.com/tennox/TypeScript-Node-Starter.git <project_name>
```
